...
<script src="<?php echo base_url();?>assets/js/jquery-ui/js/jquery.PrintArea.js_4.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/js/jquery-ui/js/jquery.printElement.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/js/jquery-ui/js/jquery.print.js" type="text/javascript"></script>
