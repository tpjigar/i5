            ...
            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_category_add/');" 
               ...
               <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="<?php echo $this->crud_model->get_image_url('category_icon',$row['category_id']);?>" class="img-circle" width="30" /></td>
                            <td><img src="<?php echo $this->crud_model->get_image_url('category',$row['category_id']);?>"  width="100" /></td>
