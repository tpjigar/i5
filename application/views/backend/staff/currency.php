            ...
            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_currency_add/');" 
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                        	<a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_currency_edit/<?php echo $row['currency_id'];?>');">
                                        ...
                                        <li>
                                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/currency/delete/<?php echo $row['currency_id'];?>');">
