<?php 
$edit_data      =   $this->db->get_where('outlets' , array('outlets_id' => $param2) )->result_array();
        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title" >
                    ...
                    <?php echo get_phrase('edit_outlets');?>
                </div>
            </div>
            <div class="panel-body">
                    <?php echo form_open(base_url() . 'admin/outlets/do_update/'.$row['outlets_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
